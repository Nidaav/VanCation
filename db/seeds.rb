...
Booking.create!( user: user1, van: van1, starts_at: 8.days.ago, ends_at: 3.days.ago, price_total: 540, status: "accepted")
Booking.create!( user: user2, van: van2, starts_at: 10.days.ago, ends_at: 6.days.ago, price_total: 480, status: "declined")
